...
export const MENS_POSES: PoseDef[] = [
  ...
  {
    id: 'mpSide',
    label: 'Physique — Quarter Turn (Side)',
    group: 'men',
    facing: 'side',
    symmetric: false,
    reveals: 'The profile between front and back: chest carriage, flat midsection, the line of the shorts.',
    judgeSees: 'A tall, stacked side view during the turn — no slouch, no forced flex.',
    cues: ['Turn on the call and re-stack: shoulders over hips over heels', 'Lift the chest; the near arm hangs long and easy', 'Keep breathing — this is a transition the judges still score'],
  },
];
...
export const WOMENS_POSES: PoseDef[] = [
  ...
  {
    id: 'bikiniSide',
    label: 'Bikini — Quarter Turn (Side)',
    group: 'women',
    facing: 'side',
    symmetric: false,
    reveals: 'The profile of the S-curve: chest up, hips back, the glute-hamstring line.',
    judgeSees: 'Whether the shape holds through the turn — posture, proportion and poise in motion.',
    cues: ['Turn crisply on the call, then settle the hip back', 'Long neck, shoulders down, soft near arm', 'Keep the line unbroken from crown to heel'],
  },
  {
    id: 'wellnessSide',
    label: 'Wellness — Quarter Turn (Side)',
    group: 'women',
    facing: 'side',
    symmetric: false,
    reveals: 'The division’s defining profile: glute and hamstring mass against a tight waist.',
    judgeSees: 'Lower-body fullness carried with an upright torso — the curve, not a lean.',
    cues: ['Push the hips back, ribs lifted', 'Near leg soft at the knee to round the hamstring', 'Shoulders stay square — let the legs do the talking'],
  },
  {
    id: 'wbFDB',
    label: 'Front Double Biceps',
    ...
    facing: 'front',
    symmetric: true,
    reveals: 'The complete front: arms, delts, chest, quads and left-to-right balance.',
    judgeSees: 'Muscularity and symmetry in the opening statement — peaks, taper and conditioning at once.',
    cues: ['Feet planted; flare the lats before the arms come up', 'Curl both arms and peak the biceps — fists closed in this division', 'Drop the traps, lift the chest, crunch down on the exhale'],
  },
  {
    id: 'wbFLS',
    label: 'Front Lat Spread',
    ...
    facing: 'front',
    symmetric: true,
    reveals: 'Back width from the front — the V-taper opened out.',
    judgeSees: 'How wide the frame can get above a controlled waist.',
    cues: ['Thumbs on the lower waist, elbows driven forward', 'Push the lats out and down to open the hood', 'Keep the midsection tight and the chest high'],
  },
  {
    id: 'wbSideChest',
    label: 'Side Chest',
    ...
    facing: 'side',
    symmetric: false,
    reveals: 'Pec thickness, the biceps, and the hamstring and calf of the bent leg.',
    judgeSees: 'Depth through the chest and one clean line down the near side.',
    cues: ['Best side to the judges; bend the front knee and raise the heel', 'Grip the wrist, press the arms together, inflate the chest', 'Twist the torso slightly toward the judges to thicken the look'],
  },
  {
    id: 'wbBDB',
    label: 'Rear Double Biceps',
    ...
    facing: 'back',
    symmetric: true,
    reveals: 'Back detail, glutes, hamstrings and calves — the whole posterior chain.',
    judgeSees: 'Density and detail from traps to calves under full tension.',
    cues: ['Mirror the front pose by feel — you can’t see it', 'Flare the lats; flex one calf with the heel raised', 'Squeeze everything at once and hold it'],
  },
  {
    id: 'wbBLS',
    label: 'Rear Lat Spread',
    ...
    symmetric: true,
    reveals: 'Back width and lat sweep seen straight on.',
    judgeSees: 'How wide the back opens and how hard it tapers to the waist.',
    cues: ['Hands on the waist, elbows forward', 'Spread the lats as wide as they will go', 'Set one foot back with the calf flexed'],
  },
  {
    id: 'wbSideTri',
    ...
    facing: 'side',
    symmetric: false,
    reveals: 'The triceps horseshoe, the side of the chest, and the near leg.',
    judgeSees: 'Arm development and conditioning down the visible side.',
    cues: ['Lock the near arm straight and slightly back', 'Grip the wrist behind you and pull to extend the triceps', 'Bend the front leg and push the calf'],
  },
  {
    id: 'wbAbs',
    label: 'Abdominals & Thighs',
...
const CATEGORY_META: Record<Category, { label: string; theme: Theme; group: 'men' | 'women'; poses: string[] }> = {
  ...
  mens_physique: { label: "Men's Physique", theme: 'ink', group: 'men', poses: ['mpFront', 'mpSide', 'mpBack'] },
  bikini: { label: 'Bikini', theme: 'marble', group: 'women', poses: ['bikiniFront', 'bikiniSide', 'backPose'] },
  wellness: { label: 'Wellness', theme: 'marble', group: 'women', poses: ['wellnessFront', 'wellnessSide', 'wellnessBack'] },
  ...
  womens_bodybuilding: { label: "Women's Bodybuilding", theme: 'marble', group: 'women', poses: ['wbFDB', 'wbFLS', 'wbSideChest', 'wbSideTri', 'wbBDB', 'wbBLS', 'wbAbs', 'mm'] },
};
